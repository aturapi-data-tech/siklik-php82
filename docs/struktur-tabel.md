...
Dibuat otomatis oleh `php artisan siklik:dok-tabel` pada 11/09/2026 06:25 dari data dictionary Oracle. Jangan edit manual.
...
| `SKTXN_RJACCDOCS.ACCDOC_ID` | ⇢ | `SKMST_ACCDOCS` | implisit |
| `SKTXN_RJACCDOCS.RJ_NO` | ⇢ | `SKTXN_RJHDRS` | implisit |
| `SKTXN_RJACTEMPS.ACTE_ID` | ⇢ | `SKMST_ACTEMPS` | implisit |
| `SKTXN_RJACTEMPS.RJ_NO` | ⇢ | `SKTXN_RJHDRS` | implisit |
| `SKTXN_RJDTLS.RJ_NO` | ⇢ | `SKTXN_RJHDRS` | implisit |
| `SKTXN_RJHDRS.REG_NO` | ⇢ | `SKMST_PASIENS` | implisit |
| `SKTXN_RJLABS.RJ_NO` | ⇢ | `SKTXN_RJHDRS` | implisit |
| `SKTXN_RJOBATRACIKANS.ACTE_DTL` | ⇢ | `SKTXN_RJACTEMPS` | implisit |
| `SKTXN_RJOBATRACIKANS.PACT_DTL` | ⇢ | `SKTXN_RJACTPARAMS` | implisit |
| `SKTXN_RJOBATRACIKANS.PRODUCT_ID` | ⇢ | `SKMST_PRODUCTS` | implisit |
| `SKTXN_RJOBATRACIKANS.RJHN_DTL` | ⇢ | `SKTXN_RJACCDOCS` | implisit |
| `SKTXN_RJOBATRACIKANS.RJOBAT_DTL` | ⇢ | `SKTXN_RJOBATS` | implisit |
| `SKTXN_RJOBATRACIKANS.RJ_NO` | ⇢ | `SKTXN_RJHDRS` | implisit |
| `SKTXN_RJOBATS.RJ_NO` | ⇢ | `SKTXN_RJHDRS` | implisit |
...
| `SKMST_CLABITEMS.LOINC_CODE` | ⇢ | `SKMST_LOINC_CODES` | implisit |
| `SKMST_CLABITEMS.PRODUCT_ID` | ⇢ | `SKMST_PRODUCTS` | implisit |
| `SKTXN_CHECKUPDTLS.CHECKUP_NO` | ⇢ | `SKTXN_CHECKUPHDRS` | implisit |
| `SKTXN_CHECKUPHDRS.REG_NO` | ⇢ | `SKMST_PASIENS` | implisit |
| `SKTXN_CHECKUPOBATS.CHECKUP_NO` | ⇢ | `SKTXN_CHECKUPHDRS` | implisit |
...
| `SKMST_RADIOLOGIS.LOINC_CODE` | ⇢ | `SKMST_LOINC_CODES` | implisit |
| `SKMST_SCPOLIS.DAY_ID` | ⇢ | `SKMST_SCDAYS` | implisit |
| `SKMST_SCPOLIS.DR_ID` | ⇢ | `SKMST_DOCTORS` | implisit |
| `SKMST_SCPOLIS.POLI_ID` | ⇢ | `SKMST_POLIS` | implisit |
...
| `SKMST_ACCDOCOTHERS.OTHER_ID` | ⇢ | `SKMST_OTHERS` | implisit |
| `SKMST_ACCDOCPRODUCTS.ACCDOC_ID` | ⇢ | `SKMST_ACCDOCS` | implisit |
| `SKMST_ACCDOCPRODUCTS.PRODUCT_ID` | ⇢ | `SKMST_PRODUCTS` | implisit |
| `SKMST_ACTEPRODS.ACTE_ID` | ⇢ | `SKMST_ACTEMPS` | implisit |
| `SKMST_ACTEPRODS.PRODUCT_ID` | ⇢ | `SKMST_PRODUCTS` | implisit |
| `SKMST_ACTPAROTHERS.OTHER_ID` | ⇢ | `SKMST_OTHERS` | implisit |
| `SKMST_ACTPAROTHERS.PACT_ID` | ⇢ | `SKMST_ACTPARAMEDICS` | implisit |
| `SKMST_ACTPARPRODUCTS.PACT_ID` | ⇢ | `SKMST_ACTPARAMEDICS` | implisit |
| `SKMST_ACTPARPRODUCTS.PRODUCT_ID` | ⇢ | `SKMST_PRODUCTS` | implisit |
...
| `SKACC_CARABAYARS.ACC_ID` | ⇢ | `SKACC_ACCOUNTSES` | implisit |
...
| `SKMST_CUSTOMERS.PROV_ID` | ⇢ | `SKMST_PROVS` | implisit |
| `SKMST_PRODUCTCONTENTS.PRODUCT_ID` | ⇢ | `SKMST_PRODUCTS` | implisit |
| `SKMST_PRODUCTCONTENTS.UOM_ID` | ⇢ | `SKMST_UOMS` | implisit |
...
| `SKTXN_SLSKIRIMS.PROV_ID` | ⇢ | `SKMST_PROVS` | implisit |
