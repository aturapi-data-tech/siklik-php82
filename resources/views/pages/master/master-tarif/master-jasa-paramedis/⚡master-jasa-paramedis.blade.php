...
new class extends Component {
    ...
    {
        $q = DB::table('skmst_actparamedics')
...
<div>
    ...
    <x-page-title
        title="Master Jasa Paramedis"
        subtitle="Kelola tarif jasa paramedis (PACT) untuk billing rawat jalan" />
                        ...
                        <tbody>
                            @forelse ($this->rows as $row)
                                <tr wire:key="jasa-paramedis-{{ $row->pact_id }}">
                                    ...
                                    <td class="ds-td-token">{{ $row->pact_id }}</td>
                                    <td class="ds-td-strong">{{ $row->pact_desc }}</td>
                                    ...
                                    <td>
                                        <div class="flex flex-wrap gap-2">
                                            ...
                                            <x-action-delete :action="'requestDelete(\'' . $row->pact_id . '\')'"
