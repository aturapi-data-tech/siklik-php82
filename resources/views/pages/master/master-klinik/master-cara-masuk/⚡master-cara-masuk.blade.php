...
<div>
    ...
    <x-page-title
        title="Master Cara Masuk"
        subtitle="Kelola tipe cara masuk pasien (Datang sendiri, Rujukan, dll)" />
                                ...
                                <tr wire:key="cara-masuk-{{ $row->entry_id }}">
                                    ...
                                    <td>
                                        <div class="flex flex-wrap gap-2">
                                            <x-action-edit wire:click="openEdit('{{ $row->entry_id }}')" />

                                            <x-action-delete :action="'requestDelete(\'' . $row->entry_id . '\')'" title="Hapus Cara Masuk"
