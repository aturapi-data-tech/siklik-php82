...
<div>
    ...
    <x-page-title
        ...
        subtitle="Kelola data pendidikan pasien" />
                                ...
                                <tr wire:key="pendidikan-{{ $row->edu_id }}">
                                    ...
                                    <td>
                                        <div class="flex flex-wrap gap-2">
                                            <x-action-edit wire:click="openEdit({{ $row->edu_id }})" />

                                            <x-action-delete :action="'requestDelete(' . $row->edu_id . ')'"
