...
<div>
    ...
    <x-page-title
        title="Master Tipe Klaim"
        subtitle="Kelola data tipe klaim (BPJS, Umum, Asuransi, dll)" />
                                ...
                                <tr wire:key="klaim-{{ $row->klaim_id }}">
                                    ...
                                    <td>
                                        <div class="flex flex-wrap gap-2">
                                            <x-action-edit wire:click="openEdit('{{ $row->klaim_id }}')" />

                                            <x-action-delete :action="'requestDelete(\'' . $row->klaim_id . '\')'" title="Hapus Tipe Klaim"
