...
new class extends Component {
    ...
    {
        $row = DB::table('skmst_signa_catatans')
    ...
    public function save(): void
    {
        $rules = [
            'form.catatan' => [
                ...
                $this->formMode === 'create'
                    ? Rule::unique('skmst_signa_catatans', 'catatan')
                    : Rule::unique('skmst_signa_catatans', 'catatan')->ignore($this->originalCatatan, 'catatan'),
            ],
        ...
        if ($this->formMode === 'create') {
            DB::table('skmst_signa_catatans')->insert([
                'catatan'       => $catatan,
                'active_status' => $activeStatus,
            ]);
        } else {
            DB::table('skmst_signa_catatans')
                ...
                <div class="flex items-start justify-between gap-4">
                    <div>
                        ...
                        <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                            LOV catatan khusus signa untuk e-resep.
                        </p>
                        <div class="mt-3">
