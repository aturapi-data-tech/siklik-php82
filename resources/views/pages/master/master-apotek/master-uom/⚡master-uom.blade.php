...
<div>
    ...
    <x-page-title
        ...
        subtitle="Kelola uom produk apotek/toko (Obat, Alkes, BHP, dll)" />
                        ...
                        <tbody>
                            @forelse ($this->rows as $row)
                                <tr wire:key="uom-{{ $row->uom_id }}">
                                    ...
                                    <td class="ds-td-token">{{ $row->uom_id }}</td>
                                    <td class="ds-td-strong">{{ $row->uom_desc }}</td>
                                    <td>
                                    ...
                                    <td>
                                        <div class="flex flex-wrap gap-2">
                                            <x-action-edit wire:click="openEdit('{{ $row->uom_id }}')" />
