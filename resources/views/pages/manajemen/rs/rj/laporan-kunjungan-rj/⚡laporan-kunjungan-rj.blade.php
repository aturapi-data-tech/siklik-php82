...
new class extends Component {
    ...
    {
        abort_unless(auth()->user()?->hasAnyRole(['Admin', 'Mr', 'Tu']), 403);
    }
...
<div>
    <x-page-title
        ...
        subtitle="Rekap kunjungan RJ — Tahunan (1 tahun, breakdown per bulan) atau Multi-Tahun (rentang yyyy–yyyy, breakdown per tahun)." />
