...
new class extends Component {
    ...
    public function rows(): array
    {
        ...
        $agg = $this->buildPendapatanKlinikAggregate($start, $end, 'YYYY');
...
<div>
    @php
        $tot = $this->totals;
        $chartKey = md5("klinik-tahunan-{$tahunMulai}-{$tahunAkhir}");
    ...
    <div class="mt-4 p-4 bg-white border border-gray-200 rounded-2xl dark:border-gray-700 dark:bg-gray-900">
        <div class="text-sm font-semibold text-gray-700 dark:text-gray-200 mb-2">
            Tren pendapatan {{ $rangeLabel }} &mdash; per tahun: <span class="text-emerald-600 dark:text-emerald-400 font-bold">RJ (BPJS+UMUM)</span> + <span class="text-amber-600 dark:text-amber-400 font-bold">Apotek</span>
        </div>
