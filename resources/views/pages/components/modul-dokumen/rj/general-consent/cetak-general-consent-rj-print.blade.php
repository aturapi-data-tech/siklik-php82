...
<x-pdf.layout-a4-with-out-background title="FORMULIR PERSETUJUAN UMUM (GENERAL CONSENT)">
    ...
    @php
        ...
        $rsName = $identitasRs->int_name ?? 'KLINIK MADINAH PRATAMA';
        ...
        <tr>
            <td colspan="4" class="border border-black px-2 py-2 text-[10px] leading-relaxed">
                ...
                <p>
                    ...
                    standar pelayanan medis yang berlaku di klinik ini.
                </p>
                <br>
                <p>
                    Saya memahami bahwa:
                ...
                <p style="padding-left: 12px;">
                    ...
                    4. Klinik menjaga kerahasiaan informasi medis saya sesuai ketentuan yang berlaku.<br>
                    5. Saya bertanggung jawab atas biaya pelayanan sesuai ketentuan klinik.<br>
