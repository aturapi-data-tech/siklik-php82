...
new class extends Component {
    ...
    {
        $items = DB::table('rsmst_acteprods')->join('tkmst_products', 'tkmst_products.product_id', 'rsmst_acteprods.product_id')->select('tkmst_products.product_id', 'tkmst_products.product_name', 'tkmst_products.sales_price', 'rsmst_acteprods.acteprod_qty')->where('acte_id', $acteId)->orderBy('acte_id')->get();
    ...
    <div class="p-4 border border-gray-200 rounded-2xl dark:border-gray-700 bg-gray-50 dark:bg-gray-800/40" x-data
        ...
        <div class="flex items-end gap-3" x-data>
            ...
            <div class="flex-1">
                ...
                <x-text-input wire:model="formEntryJasaKaryawan.jasaKaryawanDesc" placeholder="Jasa Karyawan" disabled
                    class="w-full text-sm" />
            ...
            <div class="flex gap-2 pb-0.5">
                <button type="button" wire:click.prevent="insertJasaKaryawan" wire:loading.attr="disabled"
                    wire:target="insertJasaKaryawan" class="inline-flex items-center gap-1.5 px-4 py-2 rounded-xl text-sm font-semibold
                    ...
                    <span wire:loading wire:target="insertJasaKaryawan">
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-sm text-left">
                ...
                <tbody class="divide-y divide-gray-100 dark:divide-gray-800">
                    ...
                    <tr class="transition group hover:bg-gray-50 dark:hover:bg-gray-800/40">
                        ...
                        <td class="px-4 py-3 text-center">
                            <button type="button" wire:click.prevent="removeJasaKaryawan({{ $item['rjActeDtl'] }})"
                ...
                <tfoot class="border-t border-gray-200 bg-gray-50 dark:bg-gray-800/50 dark:border-gray-700">
                    <tr>
                        <td colspan="2" class="px-4 py-3 text-sm font-semibold text-gray-600 dark:text-gray-400">Total
                        </td>
