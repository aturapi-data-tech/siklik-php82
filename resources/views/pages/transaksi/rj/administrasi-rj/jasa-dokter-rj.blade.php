        ...
        <div class="flex items-end gap-3">
            ...
            <div class="flex gap-2 pb-0.5">
                <button type="button" wire:click.prevent="insertJasaDokter" wire:loading.attr="disabled"
                    wire:target="insertJasaDokter" class="inline-flex items-center gap-1.5 px-4 py-2 rounded-xl text-sm font-semibold
                    ...
                    <span wire:loading wire:target="insertJasaDokter">
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-sm text-left">
                ...
                <tbody class="divide-y divide-gray-100 dark:divide-gray-800">
                    ...
                    <tr class="transition group hover:bg-gray-50 dark:hover:bg-gray-800/40">
                        ...
                        <td class="px-4 py-3 text-center">
                            <button type="button" wire:click.prevent="removeJasaDokter({{ $item['rjaccdocDtl'] }})"
                ...
                <tfoot class="border-t border-gray-200 bg-gray-50 dark:bg-gray-800/50 dark:border-gray-700">
                    <tr>
                        <td colspan="3" class="px-4 py-3 text-sm font-semibold text-gray-600 dark:text-gray-400">Total
                        </td>
