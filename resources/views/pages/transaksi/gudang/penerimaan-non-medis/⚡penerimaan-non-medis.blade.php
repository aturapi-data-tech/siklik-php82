...
<div>
    <x-page-title
        ...
        subtitle="Pencatatan penerimaan barang non-medis (ATK/RT) dari supplier — stok langsung bertambah (single location)" />
                ...
                <div class="flex flex-wrap items-end gap-3">
                    ...
                    <div class="flex items-end gap-2 ml-auto">
                        ...
                        <x-primary-button type="button" wire:click="openCreate" class="whitespace-nowrap"
                            title="Catat penerimaan barang non-medis baru dari Supplier">
