...
new class extends Component {
    ...
    {
        // Siklik schema: SKTXN_RCVHDRS + SKTXN_RCVDTLS, SKMST_SUPPLIERS, SKMST_KASIRS.
        // Kolom 'shift' & 'sp_no' tdk ada di SKTXN_RCVHDRS (sirus-only).
        $query = DB::table('sktxn_rcvhdrs as a')
            ...
            ->select([
                ...
                DB::raw("(SELECT SUM(
                    ...
                    - NVL(d.dtl_diskon1,0)
                ) FROM sktxn_rcvdtls d WHERE d.rcv_no = a.rcv_no) as total_detail"),
                'a.rcv_diskon',
                'a.rcv_ppn',
                'a.rcv_ppn_status',
                'a.rcv_materai',
