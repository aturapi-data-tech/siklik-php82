...
new class extends Component {
    ...
    /* ── Master list semua produk non-medis dengan saldo per year ── */
    #[Computed]
    ...
    public function simpanOpname(): void
    {
        ...
        try {
            ...
            $this->stockFisik = null;
            $this->editSaldo = '0';
            $this->loadProduct(); // refresh qty_box master yang baru disesuaikan
    ...
    /**
     * Mapping txn_status → keterangan (non-medis: hanya RCV + SO).
     */
    public static function statusLabel(string $status): array
    {
        return match ($status) {
            'RCV' => ['Beli Supplier', 'bg-emerald-100 text-emerald-800 dark:bg-emerald-900/30 dark:text-emerald-300'],
...
<div>
    <x-page-title
        ...
        subtitle="Riwayat mutasi stok barang non-medis per produk per tahun (stok tunggal)" />
        ...
        <div class="flex flex-col flex-1 min-h-0 px-6 pt-4 pb-6 space-y-4">
            ...
            <div class="grid grid-cols-1 gap-4 lg:grid-cols-12">
                        ...
                        <table class="min-w-full text-sm">
                            ...
                            <tbody class="text-gray-700 divide-y divide-gray-200 dark:divide-gray-700 dark:text-gray-200">
                                @forelse($this->productList as $row)
                                    ...
                                    @endphp
                                    <tr wire:key="prod-non-{{ $row->product_id }}"
                ...
                <div class="lg:col-span-8">
                    ...
                    {{-- DATA BARANG + SALDO + OPNAME (kanan dlm panel kanan) --}}
                    <div class="lg:col-span-5 space-y-4">
                        {{-- Card: Data Barang --}}
                        <div class="bg-white border border-gray-200 shadow-sm rounded-2xl dark:border-gray-700 dark:bg-gray-900">
                            <div class="px-5 py-4 border-b border-gray-200 dark:border-gray-700">
                                <h3 class="text-base font-semibold text-gray-900 dark:text-gray-100">Data Barang</h3>
                            </div>
                            <div class="px-5 py-4 space-y-3 text-sm">
                                ...
                                <div class="grid grid-cols-2 gap-3">
                                    ...
                                    <div>
                                        <div class="text-xs text-gray-500 dark:text-gray-400">Stok Master (qty_box)</div>
                                    ...
                                    <div>
                                        <div class="text-xs text-gray-500 dark:text-gray-400">Harga Beli</div>
                                        <div class="font-mono text-gray-700 dark:text-gray-200">Rp {{ number_format($product['cost_price'] ?? 0) }}</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="px-5 py-4 border-b border-amber-200 dark:border-amber-700 bg-amber-50/50 dark:bg-amber-950/20">
                                    ...
                                    @else
                                        <p class="mt-1 text-xs text-amber-800/80 dark:text-amber-300/80">
                                            Selisih dicatat sebagai mutasi <strong>SO</strong> di history & stok master ikut disesuaikan. Saldo awal tidak diubah.
                                        </p>
                                    @endif
                                </div>
                                        ...
                                        <div class="p-3 space-y-1 text-xs border rounded-lg bg-gray-50 border-gray-200 dark:bg-gray-800/40 dark:border-gray-700">
                                            ...
                                            @if ($delta !== 0)
                                                ...
                                                <div class="text-xs text-gray-500">
                                                    Saldo awal tetap. Mutasi opname ditambahkan ke history & qty_box master disesuaikan.
                                                </div>
                                            @else
            ...
            @else
                <div class="px-6 py-16 text-center bg-white border border-gray-200 border-dashed rounded-2xl dark:border-gray-700 dark:bg-gray-900">
                    ...
                    <p class="mt-3 text-sm text-gray-500 dark:text-gray-400">
                        Klik salah satu barang di tabel kiri untuk melihat detail kartu stock.
                    </p>
                </div>
            @endif
