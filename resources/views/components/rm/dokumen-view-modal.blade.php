...
{{-- Shell modal viewer read-only dokumen Rekam Medis RJ. --}}
    ...
    <div class="flex flex-col h-full">
        ...
        @if (filled($previewHtml))
            ...
            <div class="flex-1 min-h-0 p-3 bg-gray-100 dark:bg-gray-950/40">
                <iframe srcdoc="{{ $previewHtml }}" class="w-full h-full bg-white border border-gray-200 rounded-lg shadow-sm dark:border-gray-700"
        ...
        {{-- Footer --}}
        <div class="flex items-center justify-between gap-3 px-6 py-3 border-t border-gray-200 dark:border-gray-700">
            ...
            <div class="flex items-center gap-1.5">
                @if ($navTotal > 1)
                    ...
                    <span class="px-2 text-sm font-medium tabular-nums text-gray-500 dark:text-gray-400">{{ $navPos }} / {{ $navTotal }}</span>
