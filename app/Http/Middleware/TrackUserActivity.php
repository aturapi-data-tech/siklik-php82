    ...
    public function handle(Request $request, Closure $next): Response
    {
        if (Auth::check()) {
            ...
            if (!Cache::has($cacheKey)) {
                ...
                // Guard: kolom baru (database/sql/alter_users_add_last_seen.sql) —
                // jangan tumbangkan request bila alter belum di-deploy ke Oracle.
                try {
                    ...
                    // Kolom belum ada — skip diam-diam, fitur User Online belum aktif.
                }
