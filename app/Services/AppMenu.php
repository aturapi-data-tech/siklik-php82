...
class AppMenu
{
    ...
    private static function definitions(callable $entry): array
    {
        return [
            ...
            // ── Rujukan (SRBK FKTP) ───────────────────────────────────
            $entry(['group' => 'Rujukan', 'groupOrder' => 13, 'order' => 1, 'route' => 'rujukan.keluar', 'title' => 'Rujukan Keluar', 'desc' => 'Pemantauan rujukan berbasis kompetensi yang dikirim dari EMR Rawat Jalan (PCare-SISRUTE)', 'roles' => ['admin', 'dokter', 'mr'], 'badge' => 'RJK']),
            ...
            $entry(['group' => 'Sistem', 'groupOrder' => 14, 'order' => 6, 'route' => 'database-monitor.log-bpjs',                 'title' => 'Log BPJS API',           'desc' => 'Riwayat pemanggilan PCare, Antrean FKTP & i-Care',                     'roles' => ['admin'], 'badge' => 'LOG']),
            $entry(['group' => 'Sistem', 'groupOrder' => 14, 'order' => 7, 'route' => 'panduan-dev.struktur-tabel',              'title' => 'Struktur Tabel',         'desc' => 'Panduan dev: peta rename prefix SK, modul, relasi antar tabel & kolom (langsung dari Oracle)', 'roles' => ['admin'], 'badge' => 'DOC']),
            $entry(['group' => 'Sistem', 'groupOrder' => 14, 'order' => 8, 'route' => 'panduan-dev.rujukan-kompetensi',        'title' => 'Rujukan Kompetensi',     'desc' => 'Panduan dev: alur SRBK FKTP (PCare-SISRUTE), endpoint, payload, katalog error & mode simulasi', 'roles' => ['admin'], 'badge' => 'DOC']),
        ];
    }
}
