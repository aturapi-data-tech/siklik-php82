...
class AppMenu
{
    ...
    private static function definitions(callable $entry): array
    {
        return [
            ...
            $entry(['group' => 'Rawat Jalan', 'groupOrder' => 7, 'order' => 2, 'route' => 'rawat-jalan.daftar',             'title' => 'Daftar Rawat Jalan',  'desc' => 'Pendaftaran & manajemen pasien rawat jalan',                            'roles' => ['admin', 'mr', 'perawat', 'dokter'], 'badge' => 'RJ']),
            $entry(['group' => 'Rawat Jalan', 'groupOrder' => 7, 'order' => 3, 'route' => 'transaksi.rj.antrian-apotek-rj', 'title' => 'Antrian Apotek RJ',   'desc' => 'Antrian apotek khusus pasien rawat jalan',                              'roles' => ['admin', 'apotek'], 'badge' => 'APT-RJ']),
            ...
            $entry(['group' => 'Keuangan', 'groupOrder' => 11, 'order' => 5, 'route' => 'keuangan.saldo-kas',             'title' => 'Saldo Kas',             'desc' => 'Posisi saldo kas/bank per tanggal — admin bisa edit saldo awal tahun', 'roles' => ['admin', 'tu', 'kasir'], 'badge' => 'SLD']),
            $entry(['group' => 'Keuangan', 'groupOrder' => 11, 'order' => 6, 'route' => 'keuangan.buku-besar',            'title' => 'Buku Besar',            'desc' => 'Riwayat mutasi per akun per periode dgn saldo berjalan',               'roles' => ['admin', 'tu'], 'badge' => 'BB']),
            $entry(['group' => 'Keuangan', 'groupOrder' => 11, 'order' => 7, 'route' => 'keuangan.laba-rugi',             'title' => 'Laporan Laba Rugi',     'desc' => 'Laba/rugi bulanan & YTD — Penjualan − HPP − Biaya (template L1)',      'roles' => ['admin', 'tu'], 'badge' => 'LR']),
            $entry(['group' => 'Keuangan', 'groupOrder' => 11, 'order' => 8, 'route' => 'keuangan.neraca',                'title' => 'Laporan Neraca',        'desc' => 'Posisi keuangan per tanggal — Aktiva = Hutang + Ekuitas + Laba YTD',   'roles' => ['admin', 'tu'], 'badge' => 'NRC']),
